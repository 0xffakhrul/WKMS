        ...
        <div class="max-w-7xl mx-auto px-8 flex flex-col gap-y-6">
            <div>
                <div class="text-gray-900 text-2xl font-bold pt-10">
                    {{ __('New Leave Requests') }}
                </div>
            </div>
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('admin.leaves.store') }}" class="p-6">
                    @csrf
                    <div class="pb-4">
                        <label for="user_id" class="block mb-2 text-sm font-medium">Select Employee</label>
                        ...
                        <div class="">
                            <div class="pb-4">
                                ...
                                <input type="date" id="start_date" name="start_date"
                                    class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                    placeholder="Select date" required min="{{ now()->toDateString() }}" />
